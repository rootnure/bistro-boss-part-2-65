    ...
    return (
        <>
            <div className="card bg-base-100 rounded-xl relative">
                {price ? <p className="absolute right-2 top-2 px-1 py-0.5 rounded text-white bg-black">${price.toFixed(2)}</p> : ""}
                <figure className="h-60 rounded-t-xl overflow-hidden">
                    <img src={image} alt={name} className="min-w-full min-h-full" />
                </figure>
                <div className="card-body bg-gray-100 items-center text-center rounded-b-xl space-y-1.5">
